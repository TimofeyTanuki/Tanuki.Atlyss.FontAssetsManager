...
internal class General(ConfigFile ConfigFile)
{
    ...
    public ConfigEntry<bool> UnloadUnusedAssets = ConfigFile.Bind(Section, "DestroyUnusedAssets", true);
    public ConfigEntry<bool> RemoveCompletelyUnusedRuleFiles = ConfigFile.Bind(Section, "RemoveCompletelyUnusedRuleFiles", true);
}